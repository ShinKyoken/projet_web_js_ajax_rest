$(function() {
  ...
  connection.connect(function(err) {
    ...
    function formJeu(){
      $("#currentJeu").empty();
      $("#currentJeu")
          .append($('<div class="container currentJeu"><form class="uk-form-horizontal uk-margin-large">'))
          .append($('<div class="uk-margin-medium"><label class="uk-form-label uk-label uk-width-1-4 uk-text-center" for="form-horizontal-text">Nom du Jeu</label><div class="uk-form-controls"><input class="uk-input uk-width-1-2" id="form-horizontal-text nomJeu" type="text" placeholder="Minecraft, League of Legends, ..."></div></div>'))
          ...
          .append($('<div class="uk-margin-medium"><label class="uk-form-label uk-label uk-width-1-4 uk-text-center" for="form-horizontal-select">Éditeur du Jeu</label><div class="uk-form-controls"><select class="uk-select uk-width-1-2" id="form-horizontal-select editeurJeu">{% for editeur in editeurs %}<option>{{ editeur.nomEditeur}}</option>{% endfor %}</select></div></div>'))
