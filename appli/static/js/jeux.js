        ...
        $.ajax({
            ...
            success: function(jeux) {
                ...
                for(let i=0;i<jeux.length;i++){
                    $('#jeux')
                    .append($('<li><div class="uk-panel"><div class="uk-card uk-card-default"><div class="uk-card-header"><div class="uk-grid-small" uk-grid><div class="uk-width-auto"><img width="80" height="80" src="' + jeux[i].iconeJeu + '"></div>'
                    ...
                    + '<a href="#modal-media-youtube-' + jeux[i].idJeu + '" class="uk-button  uk-margin-small-right" uk-icon="youtube" uk-toggle></a>'
                    + '<a class="uk-button  uk-margin-small-right" uk-icon="pencil" uk-toggle></a>'
                    + '<a class="uk-button  uk-margin-small-right" uk-icon="trash" uk-toggle></a>'
